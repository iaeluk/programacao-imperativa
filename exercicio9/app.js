...
let numeroseLetras = ['pão', 'oi', 'biscoito', 'bolo', 10, 'computador', 'fone de ouvido', 'celular'];
...
let alunos = [{ nome: 'Lucas', nota: 10 }, { nome: 'Leandra', nota: 9 }, { nome: 'João', nota: 5 }, { nome: 'Fernanda', nota: 3 }, { nome: 'Peter', nota: 8 }, { nome: 'Amanda', nota: 1 }];
